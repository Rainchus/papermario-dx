...
enum Abilities {
    ...
    ABILITY_P_UP_D_DOWN_P           = 0x00000039,
    ABILITY_P_DOWN_D_UP_P           = 0x0000003A,
};
...
enum MoveIDs {
    ...
    //revised goombario attack order
    MOVE_HEADBONK1                          = 0x083,
    MOVE_TATTLE                             = 0x084,
    MOVE_CHARGE                             = 0x085,
    MOVE_MULTIBONK                          = 0x086,
    MOVE_HEADBONK2                          = 0x087,
    MOVE_HEADBONK3                          = 0x088,

    //revised kooper attack order
    MOVE_SHELL_TOSS1                        = 0x089,
    MOVE_POWER_SHELL                        = 0x08A,
    MOVE_DIZZY_SHELL                        = 0x08B,
    MOVE_FIRE_SHELL                         = 0x08C,
    MOVE_SHELL_TOSS2                        = 0x08D,
    MOVE_SHELL_TOSS3                        = 0x08E,

    //revised bombette attack order
    MOVE_BODY_SLAM1                         = 0x08F,
    MOVE_BOMB                               = 0x090,
    MOVE_POWER_BOMB                         = 0x091,
    MOVE_MEGA_BOMB                          = 0x092,
    MOVE_BODY_SLAM2                         = 0x093,
    MOVE_BODY_SLAM3                         = 0x094,

    //revised parakarry attack order
    MOVE_SKY_DIVE1                          = 0x095,
    MOVE_SHELL_SHOT                         = 0x096,
    MOVE_AIR_LIFT                           = 0x097,
    MOVE_AIR_RAID                           = 0x098,
    MOVE_SKY_DIVE2                          = 0x099,
    MOVE_SKY_DIVE3                          = 0x09A,

    //revised goompa attack order
    MOVE_UNUSED_LONE_FOOL1                  = 0x09B,
    MOVE_UNUSED_MUMBLE                      = 0x09C,
    MOVE_UNUSED_PREACH                      = 0x09D,
    MOVE_UNUSED_AWAKENING                   = 0x09E,
    MOVE_UNUSED_LONE_FOOL2                  = 0x09F,
    MOVE_UNUSED_LONE_FOOL3                  = 0x0A0,

    //revised watt attack order
    MOVE_ELECTRO_DASH1                      = 0x0A1,
    MOVE_POWER_SHOCK                        = 0x0A2,
    MOVE_TURBO_CHARGE                       = 0x0A3,
    MOVE_MEGA_SHOCK                         = 0x0A4,
    MOVE_ELECTRO_DASH2                      = 0x0A5,
    MOVE_ELECTRO_DASH3                      = 0x0A6,

    //revised sushie attack order
    MOVE_BELLY_FLOP1                        = 0x0A7,
    MOVE_SQUIRT                             = 0x0A8,
    MOVE_WATER_BLOCK                        = 0x0A9,
    MOVE_TIDAL_WAVE                         = 0x0AA,
    MOVE_BELLY_FLOP2                        = 0x0AB,
    MOVE_BELLY_FLOP3                        = 0x0AC,

    //revised lakilester attack order
    MOVE_SPINY_FLIP1                        = 0x0AD,
    MOVE_SPINY_SURGE                        = 0x0AE,
    MOVE_CLOUD_NINE                         = 0x0AF,
    MOVE_HURRICANE                          = 0x0B0,
    MOVE_SPINY_FLIP2                        = 0x0B1,
    MOVE_SPINY_FLIP3                        = 0x0B2,
    ...
    MOVE_P_UP_D_DOWN_P                       = 0x0BA,
    MOVE_P_DOWN_D_UP_P                       = 0x0BB,
};
