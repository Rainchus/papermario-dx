...
s32 ui_greenpip_png[] = {
    0x00011110, 0x00000000, 0x00123321, 0x00000000,
    0x01442244, 0x10000000, 0x12425524, 0x21000000,
    0x13256652, 0x31000000, 0x13256652, 0x31000000,
    0x12425524, 0x71000000, 0x01442244, 0x10000000,
    0x00123321, 0x00000000, 0x00011110, 0x00000000,
...
s32 ui_greenpip_pal[] = {
    0x00001C85, 0x45CF7719, 0x66953509, 0x24854E11,
    0x00010001, 0x00010001, 0x00010001, 0x00010001
};

s32 ui_redpip_pal[] = {
    0x0000B1CF, 0xDB19FCE7, 0xFC21CA53, 0xB9CFE35B,
    0x00010001, 0x00010001, 0x00010001, 0x00010001
};

s32 ui_purplepip_pal[] = {
    0x00007A25, 0xAB6FD53B, 0xC4B792A9, 0x8265ABB1,
    0x00010001, 0x00010001, 0x00010001, 0x00010001
};

s32 partner_move_purple_dot_png[] = {
0x00000000, 0x00000000, 0x00000000, 0x00000000,
0x00000000, 0x00000000, 0x00000000, 0x00000000,
0x00000000, 0x00000000, 0x00000000, 0x00000000,
0x00000000, 0x00000000, 0x00000000, 0x00000000,
...
0x00000000, 0x01111223, 0x32211110, 0x00000000,
0x00000000, 0x11122454, 0x43326111, 0x00000000,
0x00000001, 0x11255555, 0x54332611, 0x10000000,
0x00000001, 0x12777777, 0x55432261, 0x10000000,
0x00000011, 0x25788977, 0x55433266, 0x11000000,
0x00000011, 0x25788977, 0x55432226, 0x11000000,
0x0000011A, 0x45799977, 0x55433226, 0xA1100000,
0x00000112, 0x45777777, 0x54432226, 0xB1100000,
0x00000113, 0x45757575, 0x54433226, 0xB1100000,
0x00000113, 0x45555555, 0x44332226, 0xB1100000,
0x00000112, 0x34545454, 0x44333226, 0xB1100000,
0x0000011A, 0x23444444, 0x33332226, 0xA1100000,
0x00000011, 0x23333333, 0x33322266, 0x11000000,
0x00000011, 0x62332323, 0x2322226B, 0x11000000,
0x00000001, 0x16222222, 0x222226B1, 0x10000000,
0x00000001, 0x11622222, 0x22266B11, 0x10000000,
0x00000000, 0x11166666, 0x666BB111, 0x00000000,
0x00000000, 0x01111ABB, 0xBBA11110, 0x00000000,
0x00000000, 0x00011111, 0x11111000, 0x00000000,
0x00000000, 0x00000111, 0x11100000, 0x00000000,
0x00000000, 0x00000000, 0x00000000, 0x00000000,
0x00000000, 0x00000000, 0x00000000, 0x00000000,
...
s32 partner_move_purple_dot_pal[] = {
0x00002813, 0x726D8AF1, 0x9375ABF9, 0x6A29B47D,
0xE73DCE3D, 0x49215165, 0x00010001, 0x00010001
};

HudScript HES_MenuTimes = HES_TEMPLATE_CI_ENUM_SIZE(ui_menu_times, 8, 8);

HudScript HES_PartnerRank1A = HES_TEMPLATE_CI_ENUM_SIZE(ui_greenpip, 16, 16);

HudScript HES_PartnerRank1B = HES_TEMPLATE_CI_ENUM_SIZE(ui_greenpip, 16, 16);

HudScript HES_PartnerRank2A = HES_TEMPLATE_CI_ENUM_SIZE(ui_redpip, 16, 16);

HudScript HES_PartnerRank2B = HES_TEMPLATE_CI_ENUM_SIZE(ui_redpip, 16, 16);

HudScript HES_PartnerRank3A = HES_TEMPLATE_CI_ENUM_SIZE(ui_purplepip, 16, 16);

HudScript HES_PartnerRank3B = HES_TEMPLATE_CI_ENUM_SIZE(ui_purplepip, 16, 16);
...
HudScript HES_MovePurpleOrb = HES_TEMPLATE_CI_ENUM_SIZE(partner_move_purple_dot, 32, 32);
